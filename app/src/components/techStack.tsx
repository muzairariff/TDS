...
import { 
  ...
  SiOpenai, SiTailwindcss, SiTypescript, 
  SiPrisma, SiVercel, SiPython, SiHeroku 
} from "react-icons/si";
...
const techStack = [
  ...
  { icon: SiHeroku, label: "Heroku", color: "#6762A6" },
          ...
          {techStack.map((t, i) => {
            ...
            return (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: i * 0.03 }} // smaller delay, smoother
                className="flex flex-col items-center p-5 rounded-xl bg-gray-50 shadow-sm hover:shadow-md hover:-translate-y-1 transition"
              >
                <Icon 
