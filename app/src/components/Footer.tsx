...
export default function Footer() {
  return (
    <footer className="relative bg-gradient-to-br from-blue-50 via-white to-gray-50 text-gray-700 border-t border-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        {/* Logo & About */}
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">200 Gilchrist Drive, Macarthur Square, NSW 2560</p>
          <p className="text-sm text-gray-600">operations@techdirectsupport.com.au</p>
          <p className="text-sm text-gray-600">0450-424-786</p>
        </div>
      </div>

      {/* Divider + Bottom Bar */}
      <div className="border-t border-gray-200 py-6 text-center text-sm text-gray-500 relative z-10">
